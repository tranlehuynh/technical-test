...
def test_stop_buy_price(trade_page, data, shared_data):
    time.sleep(3)
    ...
    shared_data["stop_loss_price"] = current_price * 0.9
    shared_data["take_profit_price"] = current_price * 2
    shared_data["trace_input_price_value"] = current_price * 1.1

    # Buy at market price
    time.sleep(2.5)
    noti_title = trade_page.stop_buy_price(shared_data["unit"], shared_data["stop_loss_price"],
...
@pytest.mark.dependency(depends=["test_stop_buy_price"])
def test_stop_edit_buy_price(trade_page, data, shared_data):
    ...
    shared_data["take_profit_price_edit"] = shared_data["take_profit_price"] * 1.3
...
@pytest.mark.dependency(depends=["test_stop_edit_buy_price"])
