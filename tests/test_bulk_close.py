...
def test_build_close(trade_page, data, shared_data):
    time.sleep(2.5)
    noti_title = trade_page.bulk_closed_open()
    assert noti_title == "Bulk closure of open positions", "Close order validation failed!"
