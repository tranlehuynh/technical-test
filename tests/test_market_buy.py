...
def test_market_buy_price(trade_page, data, shared_data):
    time.sleep(3)
    ...
    # Buy at market price
    time.sleep(2.5)
    noti_title = trade_page.market_buy_price(shared_data["unit"], shared_data["stop_loss_price"],
    ...
    is_validate = trade_page.validate_open(shared_data["unit"], shared_data["stop_loss_price"],
                                           shared_data["take_profit_price"], "BUY")
    assert is_validate == True, "Order validation failed!"

@pytest.mark.dependency(depends=["test_market_buy_price"])
...
def test_market_edit_buy_price(trade_page, data, shared_data):
    ...
    shared_data["take_profit_price_edit"] = shared_data["take_profit_price"] * 1.1
    ...
    is_validate = trade_page.validate_open(shared_data["unit_edit"], shared_data["stop_loss_price_edit"],
                                           shared_data["take_profit_price_edit"], "BUY")
    assert is_validate == True, "Order validation failed!"
